 ...
 * 
 * @export
 * @interface UploadsInitiateDirectExternalUploadRequestMetadata
 */
export interface UploadsInitiateDirectExternalUploadRequestMetadata {
    /**
     ...
     * @type {string}
     * @memberof UploadsInitiateDirectExternalUploadRequestMetadata
     */
