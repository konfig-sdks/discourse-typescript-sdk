 ...
 * 
 * @export
 * @interface UploadsCreateMultipartExternalUploadResponse
 */
export interface UploadsCreateMultipartExternalUploadResponse {
    /**
     * The path of the temporary file on the external storage service.
     * @type {string}
     * @memberof UploadsCreateMultipartExternalUploadResponse
     */
    'key': string;
    /**
