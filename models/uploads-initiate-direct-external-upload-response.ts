 ...
 * 
 * @export
 * @interface UploadsInitiateDirectExternalUploadResponse
 */
export interface UploadsInitiateDirectExternalUploadResponse {
    /**
     * The path of the temporary file on the external storage service.
     * @type {string}
     * @memberof UploadsInitiateDirectExternalUploadResponse
     */
    'key'?: string;
    /**
